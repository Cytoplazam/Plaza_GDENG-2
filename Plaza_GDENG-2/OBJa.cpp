...
OBJa::OBJa(string name, void* shaderByteCode, size_t sizeShader) :GameObject(name, PrimitiveType::ARMADILLO)
{
...
void OBJa::update(float deltaTime)
{
...
void OBJa::draw(int w, int h, VertexShader* vs, PixelShader* ps, float forward, float right)
{
	constant cbData;
...
void OBJa::setAnimSpeed(float speed)
{
	this->speed = speed;
}
