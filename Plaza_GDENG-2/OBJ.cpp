...
OBJ::OBJ(string name, void* shaderByteCode, size_t sizeShader) :GameObject(name, PrimitiveType::TEAPOT)
{
...
void OBJ::draw(int w, int h, VertexShader* vs, PixelShader* ps, float forward, float right)
{
	constant cbData;
